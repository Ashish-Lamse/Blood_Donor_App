...
export const USER_REQUEST_DATA = createAction('USER_REQUEST_DATA') ;
export const POPUP_CHECK_BOOLEANVALUE = createAction('POPUP_CHECK_BOOLEANVALUE') ;
export const TOTAL_COMMENTS = createAction('TOTAL_COMMENTS') ;
export const COMMENT_BOOLEAN_CHECK = createAction('COMMENT_BOOLEAN_CHECK') ;
export const TEMP_COMMENT = createAction('TEMP_COMMENT') ;
